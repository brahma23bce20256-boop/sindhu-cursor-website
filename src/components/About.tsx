    ...
    <section id="about" className="section-padding relative overflow-hidden">
      <div className="mx-auto grid max-w-7xl items-center gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          <Reveal direction="left">
            <div className="relative aspect-[4/5] overflow-hidden">
              <ParallaxImage
                ...
                speed={0.2}
              />
              <div className="absolute inset-0 bg-gradient-to-t from-sindhu-charcoal/50 to-transparent" />
            </div>
          </Reveal>
          <Reveal delay={0.2}>
            <div className="mt-6 w-fit border border-sindhu-gold/30 bg-sindhu-maroon/20 p-5 backdrop-blur-sm md:absolute md:-bottom-8 md:-right-8 md:mt-0 md:p-6">
              <p className="font-display text-2xl font-light text-sindhu-gold md:text-3xl">Day 1</p>
              <p className="mt-1 text-[10px] tracking-widest text-sindhu-cream/60">ONE BIRYANI. ONE DREAM.</p>
            </div>
          </Reveal>
        </div>
        ...
        <div className="lg:pl-8">
          <Reveal>
            <p className="mb-4 text-xs tracking-[0.35em] text-sindhu-saffron">OUR STORY</p>
          </Reveal>
          <Reveal delay={0.1}>
          ...
          <Reveal delay={0.5}>
            <div className="grid grid-cols-3 gap-4 border-t border-sindhu-gold/10 pt-6 sm:gap-8 sm:pt-8">
              {[
